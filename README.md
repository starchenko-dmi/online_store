...
## В проекте имеется четыре модуля:
...
### Модуль subcategories_products.py который содержит два дочерних модуля:
1. Smartphone(Product) - Класс смартфонов
2. LawnGrass(Product) - Класс газонной травы

### Модуль BaseProduct.py 
1. BaseProduct - Абстрактный класс

### Модуль PrintMixin.py 
1. PrintMixin - Миксин класс для вывода информации о созданном объекте
